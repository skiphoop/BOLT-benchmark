...
g++ small_value.cpp -o small_value \
    -I $XRT_INCLUDE_PATH \
    -L $XRT_LIB_PATH\
...
g++ large_value.cpp -o large_value \
    -I $XRT_INCLUDE_PATH \
    -L $XRT_LIB_PATH\
    -lxrt_coreutil -lxrt_core \
    -w \
...
./small_value load_balance_1d_array_20_percent_hbm_8_value_size.xclbin
./large_value load_balance_1d_array_20_percent_hbm_64_value_size.xclbin