...
# ./host_32 load_balance_1d_array_100_percent_hbm_32_value_size.xclbin


g++ padding_host_32.cpp -o padding_host_32 \
    -I $XRT_INCLUDE_PATH \
    -L $XRT_LIB_PATH\
    -lxrt_coreutil -lxrt_core \
    -w \
    ...
    -std=c++17 \
    -Wl,-z,stack-size=10048576000000000
./padding_host_32 load_balance_1d_array_100_percent_hbm_64_value_size.xclbin